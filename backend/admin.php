...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['status']) && $_POST['status'] === 'packed') {
    ...
    if ($order) {
        // Prepare values to insert into the 'sold' table
        ...
        $insertSql = "INSERT INTO sold (product_id, image, quantity, user_email, order_date)
